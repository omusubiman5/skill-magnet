> 過去候補の記録です。2026-09-09の修正候補には適用しません。現在の結果は[集約記録](windows-explorer-leaf-launch-results.md)を参照してください。
...
<!-- explorer-results-ledger:start
{
  ...
  "release_code_sha": "5a6d4f2012a60ef8cb441dd7a74f5287f11d1bbe",
  "wheel_payload_sha256": "c97d7f0d65dd35333abf6963c0d79a240598bf91a9c1c42979036ea4354b6cee",
  ...
  "windows_explorer_field_bundle_sha256": "c53e05530a1a4428559239fd0142dbaf8bb93d967203a374f7acb7e5b002ce3b",
...
- Windows実機証拠: [署名付きbundle](evidence/windows-explorer-direct-root-0.5.9-before-20260909.json)、[native invoke記録](evidence/windows-explorer-direct-root-0.5.9-before-20260909.log)。Windows MVPの範囲で使用し、macOS実機やAI回答の完成を主張しません。
