...
class ActivationEndToEndTest(unittest.TestCase):
    ...
    def test_failed_and_blocked_surfaces_are_japanese_and_never_success(self) -> None:
        ...
        self.assertIn("raw runtime diagnostic", failed["cause"])
        self.assertIn("cloudflare-builds warning and raw JSON", blocked_output["cause"])
        self.assertIn("digest mismatch detail", blocked_acceptance["cause"])
